  ...
  return (
    ...
    >
      ...
      <div className="co2-text flex flex-col">
        <div className="main font-bold text-[7px] text-white-800">{co2Estimate.toFixed(2)}g of CO2e per page view</div>
        <div className="sub text-[7px] text-white-600">{comparison}</div>
      </div>
    </div>
  );
};
