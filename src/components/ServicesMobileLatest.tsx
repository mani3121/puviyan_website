const ServicesMobileLatest = () => {
  return (
    <div className="flex flex-col items-center p-6 lg:p-12 bg-white text-black">
      {/* Top banner */}
      <div className="bg-white text-black text-center w-full rounded-t-xl py-2">
      ...
      <hr className="w-full border-t-4 border-black my-1" />

      {/* Body content */}
      <div
        className="max-w-2xl text-justify leading-none"
